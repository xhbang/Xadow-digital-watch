...
#define BTN_UP_P		15
#define BTN_DOWN_P		16
#define BTN_SELECT_P	14

#define BTN_INT_ON()	(bit_set(PCICR, PCIE0))
#define BTN_INT_OFF()	(bit_clr(PCICR, PCIE0))
...
void buttons_init()
{
	...
	pinMode(BTN_SELECT_P,	INPUT_PULLUP);

	//shao pinPullup(BTN_UP_P,		PULLUP_ENABLE);
	//shao pinPullup(BTN_DOWN_P,	PULLUP_ENABLE);
	//shao pinPullup(BTN_SELECT_P,	PULLUP_ENABLE);

	bits_set(PCMSK0, _BV(PCINT1)|_BV(PCINT2)|_BV(PCINT3));
